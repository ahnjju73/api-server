    ...
    private <K extends Throwable> void errorToSlack(K exception){
        ...
        try {
            ...
            if(body != null) {
                ...
                restTemplate.postForEntity(isRelease ? "https://hooks.slack.com/services/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" : "https://hooks.slack.com/services/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", entity, String.class);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
